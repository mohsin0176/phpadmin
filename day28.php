...
$a = strtolower($a);// chages the case of entire string to lower case
$count = strlen($a); 
echo $count;
...
/*
$a = 'a b c d e';
$arr = explode(' ',$a); // seperate a string and places each pieces into an array with respect to a character or a string
